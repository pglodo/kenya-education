(function() {
  ...
  // RESIZING CIRCLES PER ATTRIBUTES
  ...
  function sequenceUI(girlsLayer, boysLayer) {
    ...
    $('#slider input[type=range]')
      .on('input', function() {
        ...
        titleUI(currentGrade);
      });

  }

  // CREATING THE SLIDER TITLE
  function titleUI(currentGrade) {
    var sliderGrade = L.control({
      position: 'bottomleft'
    });

    sliderGrade.onAdd = function(map) {

      var theGrade = L.DomUtil.get("slideTitle");

      L.DomEvent.disableScrollPropagation(theGrade);
      L.DomEvent.disableClickPropagation(theGrade);
    ...
    $('#slider input[type=range]')
      .on('input', function() {
        ...
        $("#slideTitle span").html(this.value);
      });
  }
  ...
  function drawLegend(data) {
    ...
    // set width and heigh for large circle
    $('.legend-large').css({
